/* Juan Francisco Torres Mart�nez - alu80
Alejandro Gallego L�pez - alu37
Santiago Molt� Mart�nez - alu55 */
...
int *quicksort(int *vec, int izq, int der){
    ...
    p = seleccionar_pivote(vec,izq,der);// posici�n central del array
    if(p >0){
        pivote = vec[p];
        i = izq;
        d = der;
